...
The unit of writing StoryTeller specifications is the Fixture.  In this guide you will learn how to write custom Fixture classes, control their projected appearance and behavior, how to add Grammars to a Fixture, and finally how to let 
