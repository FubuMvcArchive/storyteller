...
{
    public class ReflectionAssertion : LineGrammar
    {
        private readonly MethodInfo _method;
        private readonly Cell _returnCell;
        private readonly object _target;

        public ReflectionAssertion(MethodInfo method, object target)
        ...
        public static ReflectionAssertion Create<T>(Expression<Func<T, bool>> expression, T target)
        {
            return new ReflectionAssertion(FubuCore.Reflection.ReflectionHelper.GetMethod(expression), target);
        }
    }
}