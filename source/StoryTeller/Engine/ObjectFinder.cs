...
{
    public class ObjectFinder: ObjectConverter
    {
        public ObjectFinder()
        {
        }
...
//                default:
//                    StoryTellerAssert.Fail("Time periods must be expressed in seconds, minutes, hours, or days.");
//                    break;
//            }
