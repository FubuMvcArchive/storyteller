...
namespace StoryTeller.Testing
{
    ...
    public static class SpecificationExtensions
    {
        ...
        public static void ShouldEqual(this StepExecutionResult result, int rights, int wrongs, int exceptions, int syntaxErrors)
        {
            result.Counts.ShouldEqual(rights, wrongs, exceptions, syntaxErrors);
        }
        ...
        //                                                                Expression<Do<MOCK>> methodExpression)
        //    {
